        ...
        success: function(data) {
            for(let i in data) {
                ...
                let row = "<div class='col-3 my-3'>"
                    + "<div onclick='viewProduct(\"" + e['barcode'] + "\")'> <img class='img-fluid rounded img-thumbnail p-2 border-0 shadow-sm' src='https://img.freepik.com/free-photo/pink-headphones-wireless-digital-device_53876-96804.jpg' alt='Image not Available'> </div>"
                ...
                row += ("<span class='ml-1'>(" + e['reviews'] + ")</span> </div>");
